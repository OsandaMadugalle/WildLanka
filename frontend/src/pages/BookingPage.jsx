                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <label className="block text-white font-abeze font-medium mb-2">
                      ...
                      {packageData &&
                        bookingData.numberOfPeople >
                          ...
                          <span className="ml-2 text-red-400 text-xs font-abeze">
                            (Maximum group size is {packageData.maxGroupSize})
                          </span>
                        )}
                    </label>
                    <input
                          ...
                          <span className="text-green-400 font-abeze">
                            ...
                            {(() => {
                              switch (bookingData.accommodationPreference) {
                                case "Luxury":
                                  return (
                                    5000 * bookingData.numberOfPeople
                                  ).toLocaleString();
                                case "Tented Camp":
                                  return (
                                    2000 * bookingData.numberOfPeople
                                  ).toLocaleString();
                                case "Eco Lodge":
                                  return (
                                    3000 * bookingData.numberOfPeople
                                  ).toLocaleString();
                                default:
                                  return "0";
                              }
                          ...
                          <span className="text-green-400 font-abeze">
                            ...
                            {(() => {
                              switch (bookingData.transportationPreference) {
                                ...
                                case "Shared Vehicle":
                                  return (
                                    1000 * bookingData.numberOfPeople
                                  ).toLocaleString();
                                default:
                                  return "0";
                              }
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex gap-6">
                      <label
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg cursor-pointer border transition-colors duration-200 ${
                          paymentOption === "payNow"
                            ? "bg-green-700/30 border-green-400 text-green-300 font-bold shadow"
                      ...
                      <label
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg cursor-pointer border transition-colors duration-200 ${
                          paymentOption === "payLater"
                            ? "bg-yellow-600/30 border-yellow-400 text-yellow-300 font-bold shadow"
                            : "bg-gray-800 border-gray-600 text-white"
                        }`}
                        htmlFor="payLater"
                      >
                  ...
                  <button
                    ...
                    disabled={
                      isSubmitting ||
                      (packageData &&
                        bookingData.numberOfPeople > packageData.maxGroupSize)
                    }
