...
Report generated by Wildlife Safari Management System
    ...
    if (bookingsSubTab === 'available') {
      return (
        <>
          {searchBar}
          {/* Assigned Tasks */}
          {filterBookings(getAssignedBookings()).length > 0 && (
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 mb-6">
              ...
              <div className="space-y-4">
                {filterBookings(getAssignedBookings()).map((booking) => (
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
            ...
            ) : filterBookings(availableBookings.filter(b => !(b.guideId && !b.guideAccepted))).length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {filterBookings(availableBookings.filter(b => !(b.guideId && !b.guideAccepted))).map((booking) => (
  ...
  // Filtered schedule and completed renderers
