...
The Wildlife Safari Team`);
  ...
  const renderBookings = () => (
    <div className="space-y-6">
      {/* Download Options */}
      <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20 flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
        <div className="flex items-center space-x-3">
          <label htmlFor="downloadType" className="text-white font-abeze text-sm font-medium">Download as:</label>
          <select id="downloadType" value={downloadType} onChange={e => setDownloadType(e.target.value)} className="bg-gray-800 border border-gray-600 text-white text-sm rounded-lg px-3 py-2 font-abeze">
            <option value="csv">CSV</option>
            <option value="pdf">PDF</option>
          </select>
          <button onClick={handleDownloadBookings} className="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg font-abeze font-medium transition-colors duration-300 flex items-center space-x-2">
